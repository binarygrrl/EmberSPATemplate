    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new Bundle("~/bundles/templates", 
                new EmberHandlebarsBundleTransform()).IncludeDirectory("~/scripts/app/templates\\", "*.hbs", true)
                );
            bundles.Add(new ScriptBundle("~/bundles/ember").Include(
                "~/scripts/handlebars.js",
                "~/scripts/ember.min.js",
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include("~/Content/site.css").Include(
